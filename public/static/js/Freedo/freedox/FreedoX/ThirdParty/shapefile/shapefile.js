...
var parseMultiPointZ = function(record) {
    var i = 40, j, n = record.getInt32(36, true), coordinates = new Array(n);
...
var parsePolygon = function(record) {
  ...
  holes.forEach(function(hole) {
    polygons.some(function(polygon) {
      if (ringContainsSome$1(polygon[0], hole)) {
        polygon.push(hole);
        return true;
      }
    }) || polygons.push([hole]);
...
function ringContainsSome$1(ring, hole) {
...
var parsePolyLineZ = function(record) {
